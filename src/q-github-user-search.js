...
export default async function ({ user, weight = 1 }) {
  ...
  const question = html`
    <div class="mb-3">
      <p>
        Write the <strong>GitHub Search API URL</strong> to find users
        located in <strong>Berlin</strong> with more than
        <strong>100 followers</strong>, sorted by
        <strong>newest joined first</strong>.
      </p>
