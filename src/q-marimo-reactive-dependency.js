...
when their dependencies change. Unlike Jupyter, cells cannot be executed
out of order, which ensures reproducibility and eliminates hidden state bugs.
...
3. Create Cell B that computes:
   y = x * 3

4. Create Cell C that displays dynamic Markdown:
