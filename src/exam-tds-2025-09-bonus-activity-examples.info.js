export default {
  ...
  instructions: /* html */ `
    ...
    <ul>
      ...
      <li><strong>Web Scraping</strong>: IMDb data extraction, Hacker News API, Wikipedia infobox parsing, Real-time API integration</li>
    ...
    <ol>
      <li><strong>Understand the examples</strong>. Study these 14 questions and their solutions to understand the patterns.</li>
    ...
    <ol>
      ...
      <li>Search Hacker News with RSS Feed (Web Scraping - Proxy)</li>      <li><strong>NEW:</strong> Wikipedia Company Intelligence Extraction (Web Scraping - Infobox Parsing)</li>      <li>JSON Sensor Data Rollup (Data Preparation)</li>
