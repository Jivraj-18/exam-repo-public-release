export default {
  ...
  instructions: /* html */ `
    ...
    <p>This is a curated collection of 11 example questions covering key tools and techniques from the Tools in Data Science course. These examples showcase the diversity of skills taught across all modules:</p>
    <ul>
    ...
    <ol>
      <li><strong>Understand the examples</strong>. Study these 11 questions and their solutions to understand the patterns.</li>
    ...
    <ol>
      ...
      <li>Use Excel Spreadsheet Features (Spreadsheets)</li>      <li><strong>NEW:</strong> Smart Irrigation System - Farm Moisture Analysis (Excel Data Analysis)</li>      <li>FastAPI Code Generation with LLM (AI-Assisted Development)</li>
