...
export async function questions(user, elementMap) {
  const results = [
    ...
    // ===============================
    // ===== YOUR 5 NEW QUESTIONS =====
    // ===============================

    // GA5: Web Data Sourcing - DOM Inspection
    {
      ...(await import("./q-city-bounding-box.js").then((m) =>
        m.default({ user, weight: 1 }),
      )),
      help: md(geospatial),
    },

    // GA5: API Data Sourcing - Hacker News Search
    {
      ...(await import("./q-hackernews-api-search.js").then((m) =>
        m.default({ user, weight: 1 }),
      )),
      help: md(webScraping),
    },

    // GA6: Data Preparation - HTML to Structured Text
    {
      ...(await import("./q-html-table-to-markdown.js").then((m) =>
        m.default({ user, weight: 1 }),
      )),
      help: md(dataTransformation),
    },

    // GA2: Image Processing - Reconstruction
    {
      ...(await import("./q-image-reconstruction.js").then((m) =>
        m.default({ user, weight: 1 }),
      )),
      help: md(imageCompression),
    },

    // GA6: Streaming JSON & Normalization
    {
      ...(await import("./q-json-stream-normalization.js").then((m) =>
        m.default({ user, weight: 1 }),
      )),
      help: md(json),
    },
